...
public class MenuRegras extends AGScene {
    ...
    MenuRegras(AGGameManager gerenciador){
        super(gerenciador);
    }
    ...
    public void init() {
        ...
        r1 = createSprite(R.drawable.regras,1,1);
        r1.setScreenPercent(100,90);
        r1.vrPosition.setXY((maxWX/2),(maxHY/2));
